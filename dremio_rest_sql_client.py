...
class DremioRestSqlClient:
    ...
    def __init__(self, base_url: str = None, pat: str = None, project_id: str = None):
        ...
        self.base_url = base_url or os.getenv('DREMIO_CLOUD_URL', 'https://api.dremio.cloud')
    ...
    def submit_query(self, sql: str, context: List[str] = None, 
                    references: Dict[str, Dict[str, str]] = None) -> str:
        """
    ...
    def get_job_results(self, job_id: str, limit: int = 500, offset: int = 0) -> Dict[str, Any]:
        """
    ...
    def wait_for_completion(self, job_id: str) -> Dict[str, Any]:
        ...
        raise TimeoutError(f"Job {job_id} did not complete within {self.max_poll_time} seconds")
    
    def execute_query(self, sql: str, context: List[str] = None, 
...
def main():
    ...
    if connection_result['success']:
        ...
        result = client.execute_query("SELECT 1 as test_value, 'Hello from REST API' as message")
